...
@Operation(
        summary = "Создание сообщения в чате и рассылка его по WebSocket участникам чата",
        description = """
                    Отправлять сообщение в чат могут только его участники.
        ...
        responses = {
                ...
                @ApiResponse(
                        ...
                        content = @Content(
                                ...
                                examples = {
                                        @ExampleObject(
                                                name = "Отправка сообщения не участником чата",
                                                value = """
                                                        {
                                                            "success": false,
                                                            "message": "Доступ к чужому чату запрещён"
                                                        }
                                                        """
                                        ),
                                        @ExampleObject(
